...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/YoKaida63/King67/'..readfile('newvape/profiles/commit.txt')..'/'..select(1, path:gsub('newvape/', '')), true)
		end)
...
scarcitybanner.Text = 'thanks for buying KingV4 Premium gng.Join KingV4 server to report any bugs, suggestions or buy prem, click discord icon :D'
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/YoKaida63/King67/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
